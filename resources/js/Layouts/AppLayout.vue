    ...
    <div class="min-h-screen bg-slate-50">
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-10">
            <div class="flex items-end justify-around h-16 max-w-md mx-auto px-2">
                <!-- Home -->
                <Link href="/dashboard" class="flex-1 flex flex-col items-center gap-0.5 py-2.5" :class="isActive('/dashboard') ? 'text-indigo-600' : 'text-slate-600'">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    <span class="text-2xs font-medium">{{ t('nav.home') }}</span>
                </Link>

                <!-- Services -->
                <Link href="/services" class="flex-1 flex flex-col items-center gap-0.5 py-2.5" :class="isActive('/services') ? 'text-indigo-600' : 'text-slate-600'">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span class="text-2xs font-medium">{{ t('nav.services') }}</span>
                </Link>
                ...
                <!-- Songs -->
                <Link href="/songs" class="flex-1 flex flex-col items-center gap-0.5 py-2.5" :class="isActive('/songs') ? 'text-indigo-600' : 'text-slate-600'">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z" />
                    </svg>
                    <span class="text-2xs font-medium">{{ t('nav.songs') }}</span>
                </Link>
                ...
                <Link
                    ...
                    :class="isActive('/settings') ? 'text-indigo-600' : 'text-slate-600'"
                >
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span class="text-2xs font-medium">{{ t('nav.settings') }}</span>
                </Link>
            </div>
        </nav>
    </div>

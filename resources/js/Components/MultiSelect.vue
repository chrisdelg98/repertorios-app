            ...
            >
                ...
                >
                    ...
                    <div v-if="searchable" class="relative border-b border-slate-100">
                        <svg class="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-600 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="overflow-y-auto flex-1">
                        <p v-if="!options.length" class="px-3.5 py-2.5 text-sm text-slate-600 italic">{{ emptyLabel }}</p>
                        <p v-else-if="!filteredOptions.length" class="px-3.5 py-2.5 text-sm text-slate-600 italic">{{ noResultsLabel }}</p>

...
<template>
    <Teleport to="body">
        ...
        <div
            v-if="open"
            class="fixed bottom-0 left-1/2 lg:left-[calc(50%+8rem)] -translate-x-1/2 w-full sm:max-w-lg lg:max-w-2xl z-50 bg-white rounded-t-2xl px-4 pt-4 pb-6 max-h-[80vh] flex flex-col shadow-xl"
        >

        ...
        <div class="px-4 lg:px-8 py-5 lg:py-10 max-w-lg lg:max-w-3xl mx-auto">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    >
                        <span :class="selection.kind === 'other' ? 'text-slate-600' : 'text-slate-900 font-medium'">
                            {{ selectionLabel }}
                        </span>
                    ...
                    <div v-if="selection.kind === 'custom'" class="mt-1">
                        ...
                        />
                        <p class="text-xs text-slate-600 text-right mt-0.5">{{ customName.length }}/20</p>
                    </div>
                </div>
                    ...
                    <div class="overflow-y-auto flex-1 space-y-1 pb-2">
                        ...
                        >
                            ...
                            <span
                                ...
                                class="text-xs text-slate-600 ml-2"
                            >
                                {{ tpl.time.slice(0, 5) }}
                            </span>
                        </button>

                        <p v-if="search && !filteredTemplates.length" class="text-sm text-slate-600 text-center py-4">
